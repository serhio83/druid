...
func easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs(in *jlexer.Lexer, out *Responce) {
...
func easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs(out *jwriter.Writer, in Responce) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs1(in *jlexer.Lexer, out *Message) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs1(out *jwriter.Writer, in Message) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Message) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs2(in *jlexer.Lexer, out *Label) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs2(out *jwriter.Writer, in Label) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Label) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Label) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs2(l, v)
}
func easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs3(in *jlexer.Lexer, out *Annotation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs3(out *jwriter.Writer, in Annotation) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Annotation) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs3(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs4(in *jlexer.Lexer, out *Alert) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs4(out *jwriter.Writer, in Alert) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Alert) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6a975c40EncodeGithubComSerhio83DruidPkgStructs4(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Alert) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs4(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Alert) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6a975c40DecodeGithubComSerhio83DruidPkgStructs4(l, v)
}
